...
func TestEth_GasPrice(t *testing.T) {
	...
	if gasprice.IsEqual(types.EtherValueZero()) {
		t.Errorf("gas price cant be 0")
	}

	if gasprice.BigInt().Cmp(types.EtherValueOne().BigInt()) != -1 {
...
func getBlock_4ad331() *types.EtherBlock {
	block := "0x4ad331e4f8076ca863fcfbc407d17a0f4c8086ca3288a0f7e00965f3b634d04b"
	hash, _ := types.NewHexString(block)
	parentHash, _ := types.NewHexString("0x7af09e57a36cc4362f944f328792c062e342f9ebf1e0a5aff9dfb1617f011c30")
	nonce, _ := types.NewHexString("0xe8931c7c0b7068cc")
	sha3Uncles, _ := types.NewHexString("0x1dcc4de8dec75d7aab85b567b6ccd41ad312451b948a7413f0a142fd40d49347")
	logsBloom, _ := types.NewHexString("")
	transactionsRoot, _ := types.NewHexString("0x2dfd960db39f5e8f0029e9d074ecb4585b21f44de7ee8cba625831870f0c90a7")
	stateRoot, _ := types.NewHexString("0x959dd2b6888cab28bf25b5324270d0f34f998821443309e8f5e7f31c90b45a7c")
	receiptsRoot, _ := types.NewHexString("0x805858cd10a988c1300811dcb48fbb78d65966f75eacea524496037c06e09022")

	ea, _ := new(types.EtherAddress).FromString("0xb2930b35844a230f00e51431acae96fe543a0347")
	...
	extraData, _ := types.NewHexString("0x7337")
...
func getTransaction_99192() *types.EtherTransaction {
	...
	input, _ := types.NewHexString("0xd0e30db0")
	hash, _ := types.NewHexString("0x99192da8574412d70d210b73d859904a0f3d1493051d751e4f32fb2905d1844a")
	blockHash, _ := types.NewHexString("0x4ad331e4f8076ca863fcfbc407d17a0f4c8086ca3288a0f7e00965f3b634d04b")
	v, _ := types.NewHexString("0x1b")
	r, _ := types.NewHexString("0x948153c3a2f21176d6606a39f1442f3711352c745bf47de69a663d60c4334bc9")
	s, _ := types.NewHexString("0x88a88fbeda64ae8b5195efe296712ee2bd0a324f4ac45b50c863f41a2957531")
	...
	return &types.EtherTransaction{
		...
		Input:            *input,
		TransactionIndex: 85,
		Value:            *new(types.EtherValue).FromBigInt(big.NewInt(100000000000000000)),
		V:                *v,
		R:                *r,
		S:                *s,
	}
...
func HashToEtherTransactionFull(l []types.HexString) []types.EtherTransaction {
	newList := make([]types.EtherTransaction, 0)
	for _, v := range l {
		newList = append(newList, types.EtherTransaction{Hash: v})
	}
	return newList
}

func getTransactionReceipt_99192() *types.EtherTransactionReceipt {
	logs := types.EtherLogRaw{
	...
	raw := types.TransactionReceiptRaw{
		TransactionHash:   "0x99192da8574412d70d210b73d859904a0f3d1493051d751e4f32fb2905d1844a",
		TransactionIndex:  "0x55",
		BlockNumber:       "0x4fe363",
		BlockHash:         "0x4ad331e4f8076ca863fcfbc407d17a0f4c8086ca3288a0f7e00965f3b634d04b",
